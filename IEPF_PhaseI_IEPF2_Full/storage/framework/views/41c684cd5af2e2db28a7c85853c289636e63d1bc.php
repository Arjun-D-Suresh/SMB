...
<script>
    ...
    $(document).ready(function() {
        ...
        let searchFunction = () => {
            ...
            var saveData = $.ajax({
                type: 'POST',
                url: "<?php echo e(url('/folio-header-data')); ?>",
                ...
                success: function(resultData) {
                    ...
                    $('.urnSelect').click(function() {
                        ...
                        var saveData = $.ajax({
                            type: 'POST',
                            url: "<?php echo e(url('/folio-dividend-data')); ?>",
                            data: folio,
                            dataType: "text",
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/srikanth2k23/public_html/resources/views/folioDetails.blade.php ENDPATH**/ ?>